 ...
 */
class StockCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StockCreate';
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 999)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling StockCreate., must be smaller than or equal to 999.');
        }
        if (($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling StockCreate., must be bigger than or equal to 0.');
        }
