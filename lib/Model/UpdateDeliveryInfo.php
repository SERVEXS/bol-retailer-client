...
/**
 * UpdateDeliveryInfo Class Doc Comment
 *
 * @category Class
 * @package  ServeXS\BolRetailer\v7
 * @author   OpenAPI Generator team
 ...
 */
class UpdateDeliveryInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateDeliveryInfo';
     ...
     *
     * @param string|null $expected_delivery_date The expected delivery date of the shipment at the bol.com warehouse. In ISO 8601 format.
     *
     * @return self
     */
