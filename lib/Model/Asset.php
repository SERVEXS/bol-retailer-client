...
class Asset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setUrl($url)
    {
        if ((mb_strlen($url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $url when calling Asset., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($url) < 0)) {
            throw new \InvalidArgumentException('invalid length for $url when calling Asset., must be bigger than or equal to 0.');
        }
