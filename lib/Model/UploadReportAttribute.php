...
class UploadReportAttribute implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'values' => '\ServeXS\BolRetailer\v7\Model\UploadReportValue[]',
        'status' => 'string',
        'sub_status' => 'string',
     ...
     * Gets values
     *
     * @return \ServeXS\BolRetailer\v7\Model\UploadReportValue[]
     */
     ...
     * Sets values
     *
     * @param \ServeXS\BolRetailer\v7\Model\UploadReportValue[] $values values
     *
     * @return self
     */
