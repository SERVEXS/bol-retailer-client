...
class ProductLabelsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'label_format' => 'string',
        'products' => '\ServeXS\BolRetailer\v7\Model\ProductLabelsProduct[]'
    ];
     ...
     * Gets products
     *
     * @return \ServeXS\BolRetailer\v7\Model\ProductLabelsProduct[]
     */
     ...
     * Sets products
     *
     * @param \ServeXS\BolRetailer\v7\Model\ProductLabelsProduct[] $products products
     *
     * @return self
     */
