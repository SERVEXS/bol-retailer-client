...
class OrderFulfilment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets method
     *
     * @param string|null $method The fulfilment method. Fulfilled by the retailer (FBR) or fulfilled by bol.com (FBB).
     *
     * @return self
     */
     ...
     *
     * @param string|null $time_frame_type Delivery option selected by the customer.
     *
     * @return self
     */
