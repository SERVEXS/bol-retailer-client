...
class Product implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'ean' => 'string',
        'relevance_scores' => '\ServeXS\BolRetailer\v7\Model\RelevanceScore[]',
        'maximum_price' => 'float'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['relevance_scores'] = $data['relevance_scores'] ?? null;
     ...
     *
     * @return \ServeXS\BolRetailer\v7\Model\RelevanceScore[]|null
     */
     ...
     *
     * @param \ServeXS\BolRetailer\v7\Model\RelevanceScore[]|null $relevance_scores relevance_scores
     *
     * @return self
     */
     ...
     * Sets maximum_price
     *
     * @param float|null $maximum_price The maximum price a product can have in order to be part of the promotion.
     *
     * @return self
     */
