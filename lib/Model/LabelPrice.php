 ...
 */
class LabelPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LabelPrice';
     ...
     * Sets total_price
     *
     * @param float $total_price The price that is charged for this delivery option, excluding VAT.
     *
     * @return self
     */
