...
class ShipmentsApi
{
     ...
     * @return \ServeXS\BolRetailer\v7\Model\Shipment|\ServeXS\BolRetailer\v7\Model\Problem
     */
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ServeXS\BolRetailer\v7\Model\Shipment|\ServeXS\BolRetailer\v7\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getShipmentWithHttpInfo($shipment_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ServeXS\BolRetailer\v7\Model\Shipment' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ServeXS\BolRetailer\v7\Model\Shipment', []),
            ...
            $returnType = '\ServeXS\BolRetailer\v7\Model\Shipment';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ServeXS\BolRetailer\v7\Model\Shipment',
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ServeXS\BolRetailer\v7\Model\ShipmentsResponse|\ServeXS\BolRetailer\v7\Model\Problem
     */
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ServeXS\BolRetailer\v7\Model\ShipmentsResponse|\ServeXS\BolRetailer\v7\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getShipmentsWithHttpInfo($page = 1, $fulfilment_method = 'FBR', $order_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ServeXS\BolRetailer\v7\Model\ShipmentsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ServeXS\BolRetailer\v7\Model\ShipmentsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ServeXS\BolRetailer\v7\Model\ShipmentsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ServeXS\BolRetailer\v7\Model\ShipmentsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
