...
class ReturnsApi
{
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ServeXS\BolRetailer\v7\Model\ModelReturn|\ServeXS\BolRetailer\v7\Model\Problem
     */
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ServeXS\BolRetailer\v7\Model\ModelReturn|\ServeXS\BolRetailer\v7\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReturnWithHttpInfo($return_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ServeXS\BolRetailer\v7\Model\ModelReturn' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ServeXS\BolRetailer\v7\Model\ModelReturn', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\ServeXS\BolRetailer\v7\Model\ModelReturn';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ServeXS\BolRetailer\v7\Model\ModelReturn',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ServeXS\BolRetailer\v7\Model\ReturnsResponse|\ServeXS\BolRetailer\v7\Model\Problem
     */
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ServeXS\BolRetailer\v7\Model\ReturnsResponse|\ServeXS\BolRetailer\v7\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReturnsWithHttpInfo($page = 1, $handled = null, $fulfilment_method = 'FBR')
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ServeXS\BolRetailer\v7\Model\ReturnsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ServeXS\BolRetailer\v7\Model\ReturnsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ServeXS\BolRetailer\v7\Model\ReturnsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ServeXS\BolRetailer\v7\Model\ReturnsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
