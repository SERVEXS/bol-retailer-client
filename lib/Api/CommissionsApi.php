...
class CommissionsApi
{
     ...
     * @return \ServeXS\BolRetailer\v7\Model\Commission|\ServeXS\BolRetailer\v7\Model\Problem|\ServeXS\BolRetailer\v7\Model\Problem
     */
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ServeXS\BolRetailer\v7\Model\Commission|\ServeXS\BolRetailer\v7\Model\Problem|\ServeXS\BolRetailer\v7\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCommissionWithHttpInfo($ean, $unit_price, $condition = 'NEW')
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ServeXS\BolRetailer\v7\Model\Commission' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ServeXS\BolRetailer\v7\Model\Commission', []),
            ...
            $returnType = '\ServeXS\BolRetailer\v7\Model\Commission';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ServeXS\BolRetailer\v7\Model\Commission',
     ...
     *
     * @param  \ServeXS\BolRetailer\v7\Model\BulkCommissionRequest $body body (optional)
     *
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ServeXS\BolRetailer\v7\Model\BulkCommissionResponse|\ServeXS\BolRetailer\v7\Model\Problem|\ServeXS\BolRetailer\v7\Model\Problem
     */
     ...
     * Get all commissions and reductions by EAN in bulk
     *
     * @param  \ServeXS\BolRetailer\v7\Model\BulkCommissionRequest $body (optional)
     *
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ServeXS\BolRetailer\v7\Model\BulkCommissionResponse|\ServeXS\BolRetailer\v7\Model\Problem|\ServeXS\BolRetailer\v7\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCommissionsWithHttpInfo($body = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ServeXS\BolRetailer\v7\Model\BulkCommissionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ServeXS\BolRetailer\v7\Model\BulkCommissionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ServeXS\BolRetailer\v7\Model\BulkCommissionResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ServeXS\BolRetailer\v7\Model\BulkCommissionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
