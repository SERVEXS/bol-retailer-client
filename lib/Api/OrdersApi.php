...
class OrdersApi
{
     ...
     *
     * @param  \ServeXS\BolRetailer\v7\Model\ContainerForTheOrderItemsThatHaveToBeCancelled $body body (optional)
     *
     ...
     * Cancel an order item by an order item id
     *
     * @param  \ServeXS\BolRetailer\v7\Model\ContainerForTheOrderItemsThatHaveToBeCancelled $body (optional)
     *
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ServeXS\BolRetailer\v7\Model\Order|\ServeXS\BolRetailer\v7\Model\Problem
     */
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ServeXS\BolRetailer\v7\Model\Order|\ServeXS\BolRetailer\v7\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderWithHttpInfo($order_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ServeXS\BolRetailer\v7\Model\Order' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ServeXS\BolRetailer\v7\Model\Order', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\ServeXS\BolRetailer\v7\Model\Order';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ServeXS\BolRetailer\v7\Model\Order',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $status Determines whether you want to retrieve orders including or excluding shipped and/or cancelled items. (optional, default to 'OPEN')
     *
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ServeXS\BolRetailer\v7\Model\ReducedOrders
     */
    public function getOrders($page = 1, $fulfilment_method = 'FBR', $status = 'OPEN')
    {
        list($response) = $this->getOrdersWithHttpInfo($page, $fulfilment_method, $status);
        return $response;
    }
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ServeXS\BolRetailer\v7\Model\ReducedOrders, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrdersWithHttpInfo($page = 1, $fulfilment_method = 'FBR', $status = 'OPEN')
    {
        $request = $this->getOrdersRequest($page, $fulfilment_method, $status);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ServeXS\BolRetailer\v7\Model\ReducedOrders' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ServeXS\BolRetailer\v7\Model\ReducedOrders', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ServeXS\BolRetailer\v7\Model\ReducedOrders';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ServeXS\BolRetailer\v7\Model\ReducedOrders',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrdersAsync($page = 1, $fulfilment_method = 'FBR', $status = 'OPEN')
    {
        return $this->getOrdersAsyncWithHttpInfo($page, $fulfilment_method, $status)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrdersAsyncWithHttpInfo($page = 1, $fulfilment_method = 'FBR', $status = 'OPEN')
    {
        $returnType = '\ServeXS\BolRetailer\v7\Model\ReducedOrders';
        $request = $this->getOrdersRequest($page, $fulfilment_method, $status);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrdersRequest($page = 1, $fulfilment_method = 'FBR', $status = 'OPEN')
    {
        if ($page !== null && $page < 1) {
     ...
     * Ship order item
     *
     * @param  \ServeXS\BolRetailer\v7\Model\ShipmentRequest $body body (optional)
     *
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ServeXS\BolRetailer\v7\Model\ProcessStatus|\ServeXS\BolRetailer\v7\Model\Problem
     ...
     * Ship order item
     *
     * @param  \ServeXS\BolRetailer\v7\Model\ShipmentRequest $body (optional)
     *
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ServeXS\BolRetailer\v7\Model\ProcessStatus|\ServeXS\BolRetailer\v7\Model\Problem, HTTP status code, HTTP response headers (array of strings)
