...
class SubscriptionsApi
{
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ServeXS\BolRetailer\v7\Model\SubscriptionResponse|\ServeXS\BolRetailer\v7\Model\Problem|\ServeXS\BolRetailer\v7\Model\Problem
     */
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ServeXS\BolRetailer\v7\Model\SubscriptionResponse|\ServeXS\BolRetailer\v7\Model\Problem|\ServeXS\BolRetailer\v7\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPushNotificationSubscriptionWithHttpInfo($subscription_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ServeXS\BolRetailer\v7\Model\SubscriptionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ServeXS\BolRetailer\v7\Model\SubscriptionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ServeXS\BolRetailer\v7\Model\SubscriptionResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ServeXS\BolRetailer\v7\Model\SubscriptionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ServeXS\BolRetailer\v7\Model\SubscriptionsResponse|\ServeXS\BolRetailer\v7\Model\Problem
     */
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ServeXS\BolRetailer\v7\Model\SubscriptionsResponse|\ServeXS\BolRetailer\v7\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPushNotificationSubscriptionsWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ServeXS\BolRetailer\v7\Model\SubscriptionsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ServeXS\BolRetailer\v7\Model\SubscriptionsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ServeXS\BolRetailer\v7\Model\SubscriptionsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ServeXS\BolRetailer\v7\Model\SubscriptionsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ServeXS\BolRetailer\v7\Model\KeySetResponse
     */
     ...
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ServeXS\BolRetailer\v7\Model\KeySetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubscriptionKeysWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ServeXS\BolRetailer\v7\Model\KeySetResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ServeXS\BolRetailer\v7\Model\KeySetResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ServeXS\BolRetailer\v7\Model\KeySetResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ServeXS\BolRetailer\v7\Model\KeySetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \ServeXS\BolRetailer\v7\Model\CreateSubscriptionRequest $body body (optional)
     *
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ServeXS\BolRetailer\v7\Model\ProcessStatus|\ServeXS\BolRetailer\v7\Model\Problem
     ...
     * Create push notification subscription
     *
     * @param  \ServeXS\BolRetailer\v7\Model\CreateSubscriptionRequest $body (optional)
     *
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ServeXS\BolRetailer\v7\Model\ProcessStatus|\ServeXS\BolRetailer\v7\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  string $subscription_id A unique identifier for the subscription. (required)
     * @param  \ServeXS\BolRetailer\v7\Model\UpdateSubscriptionRequest $body body (optional)
     *
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ServeXS\BolRetailer\v7\Model\ProcessStatus|\ServeXS\BolRetailer\v7\Model\Problem
     ...
     *
     * @param  string $subscription_id A unique identifier for the subscription. (required)
     * @param  \ServeXS\BolRetailer\v7\Model\UpdateSubscriptionRequest $body (optional)
     *
     * @throws \ServeXS\BolRetailer\v7\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ServeXS\BolRetailer\v7\Model\ProcessStatus|\ServeXS\BolRetailer\v7\Model\Problem, HTTP status code, HTTP response headers (array of strings)
