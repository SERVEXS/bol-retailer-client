...
namespace ServeXS\BolRetailer\v7;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.bol.com';
    ...
    {
        $report  = 'PHP SDK (ServeXS\BolRetailer\v7) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 7.x' . PHP_EOL;
